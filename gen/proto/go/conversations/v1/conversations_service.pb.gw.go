...
/*
Package conversationsv1 is a reverse proxy.
...
func RegisterConversationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ConversationServiceServer) error {
	...
	mux.Handle("POST", pattern_ConversationService_CreateConversation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/conversations.v1.ConversationService/CreateConversation", runtime.WithHTTPPathPattern("/v1/conversations"))
		if err != nil {
...
func RegisterConversationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ConversationServiceClient) error {
	...
	mux.Handle("POST", pattern_ConversationService_CreateConversation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/conversations.v1.ConversationService/CreateConversation", runtime.WithHTTPPathPattern("/v1/conversations"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
